...
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1106-ipc.config rv1106-nand.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106g-38x38-ipc-v10-spi-nand.dts
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),1M(uboot),4M(boot),32M(rootfs),48M(oem),32M(userdata)"
