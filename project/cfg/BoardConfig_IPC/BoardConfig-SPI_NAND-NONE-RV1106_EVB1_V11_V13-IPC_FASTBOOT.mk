...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rv1106-spi-nand-tb-nofastae_defconfig

# Uboot defconfig fragment
export RK_UBOOT_DEFCONFIG_FRAGMENT=rk-sfc.config

# Uboot Loader ini overlay
export RK_UBOOT_RKBIN_INI_OVERLAY=RKBOOT/RV1106MINIALL_SPI_NAND_TB_NOMCU.ini

# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rv1106_defconfig

# Kernel defconfig fragment
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1106-tb-nofastae.config rv1106-nand.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106g-evb1-v11-fastboot-spi-nand.dts
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),512K(uboot),32M(boot),32M(userdata),-(reserved)"
